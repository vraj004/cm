...
MODULE COUPLED_FINITEELASTIC_DARCY_ROUTINES
  ...
  PUBLIC COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR,COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY
  PUBLIC COUPLED_ELASTICDARCY_CONTROL_LOOP_PRE_LOOP
...
CONTAINS
  ...
  SUBROUTINE COUPLED_FINITEELASTIC_DARCY_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_MULTI_PHYSICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_COUPLED_FINITEELASTIC_DARCY_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE
      CASE DEFAULT
...
999 CALL ERRORS("COUPLED_FINITEELASTIC_DARCY_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE COUPLED_FINITEELASTIC_DARCY_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: GEOMETRIC_MESH_COMPONENT,GEOMETRIC_SCALING_TYPE,NUMBER_OF_COMPONENTS, &
      ...
      & velocity_comp_idx, NUMBER_OF_SOLIDCOMPONENTS,NUMBER_OF_FLUIDCOMPONENTS
    ...
    NUMBER_OF_COMPONENTS = NUMBER_OF_DIMENSIONS+1 !setting up u,p formulation from Borja.

    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      SELECT CASE(EQUATIONS_SET%SUBTYPE)
      CASE(EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE,&
        & EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE)
          ...
          CASE(EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE, &
            ...
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                ! Default dependent field displacements to the geometric interpolation setup
              ...
              ELSE
                ...
                CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                  ...
                  CALL FIELD_COMPONENT_INTERPOLATION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U_VARIABLE_TYPE,NUMBER_OF_DIMENSIONS+1, &
                    & FIELD_NODE_BASED_INTERPOLATION,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_INTERPOLATION_CHECK(EQUATIONS_SET_SETUP%FIELD, &
                    & FIELD_DELUDELN_VARIABLE_TYPE,NUMBER_OF_DIMENSIONS+1, &
                    & FIELD_NODE_BASED_INTERPOLATION,ERR,ERROR,*999)
        ...
        !-----------------------------------------------------------------
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE.OR. &
                & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE) THEN
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              ...
              IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_VARIABLE_TYPES_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,[FIELD_U_VARIABLE_TYPE, &
                    & FIELD_V_VARIABLE_TYPE,FIELD_U1_VARIABLE_TYPE,FIELD_V1_VARIABLE_TYPE],ERR,ERROR,*999)
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                   & NUMBER_OF_SOLIDCOMPONENTS,ERR,ERROR,*999)
                ...
                CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE, &
                  & "Solid Density",ERR,ERROR,*999)

                DO component_idx=1,NUMBER_OF_SOLIDCOMPONENTS
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U1_VARIABLE_TYPE, &
                   & NUMBER_OF_FLUIDCOMPONENTS,ERR,ERROR,*999)
                CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U1_VARIABLE_TYPE,"Fluid Params", &
                  & ERR,ERROR,*999)
                CALL FIELD_DIMENSION_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & FIELD_VECTOR_DIMENSION_TYPE,ERR,ERROR,*999)
                CALL FIELD_DATA_TYPE_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & FIELD_DP_TYPE,ERR,ERROR,*999)
                CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & "Fluid Density",ERR,ERROR,*999)

                DO component_idx=1,NUMBER_OF_FLUIDCOMPONENTS
                ...
                !Fluid density
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                   & 1,ERR,ERROR,*999)
                CALL FIELD_COMPONENT_INTERPOLATION_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & 1,FIELD_CONSTANT_INTERPOLATION,ERR,ERROR,*999)
                CALL FIELD_COMPONENT_MESH_COMPONENT_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & 1,GEOMETRIC_MESH_COMPONENT,ERR,ERROR,*999)
              ...
              ELSE
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U1_VARIABLE_TYPE, &
                  & NUMBER_OF_FLUIDCOMPONENTS,ERR,ERROR,*999)
                CALL FIELD_NUMBER_OF_COMPONENTS_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & 1,ERR,ERROR,*999)
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                ...
                !Initialise darcy permiability and viscosity properties to 1.0
                CALL FIELD_NUMBER_OF_COMPONENTS_GET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U1_VARIABLE_TYPE, &
                  & NUMBER_OF_FLUIDCOMPONENTS,ERR,ERROR,*999)
                DO component_idx=1,NUMBER_OF_FLUIDCOMPONENTS-1
                  CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U1_VARIABLE_TYPE, &
                    & FIELD_VALUES_SET_TYPE,component_idx,1.0_DP,ERR,ERROR,*999)
                ENDDO
                !set porosity to 0.5
                CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U1_VARIABLE_TYPE, &
                  & FIELD_VALUES_SET_TYPE,NUMBER_OF_FLUIDCOMPONENTS,0.5_DP,ERR,ERROR,*999)

                !Initialise fluid density to 0
                CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_V1_VARIABLE_TYPE, &
                  & FIELD_VALUES_SET_TYPE,1,0.0_DP,ERR,ERROR,*999)
        ...
        !-----------------------------------------------------------------
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FINISHED) THEN
              ...
              CALL EQUATIONS_TIME_DEPENDENCE_TYPE_SET(EQUATIONS,EQUATIONS_SECOND_ORDER_DYNAMIC,ERR,ERROR,*999)
            ELSE
              CALL FLAG_ERROR("Equations set dependent field has not been finished.",ERR,ERROR,*999)
            ENDIF
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
              ...
              CALL EQUATIONS_MAPPING_DYNAMIC_MATRICES_SET(EQUATIONS_MAPPING,.TRUE.,.TRUE.,.TRUE.,ERR,ERROR,*999)
              ...
              !Set up lumping
                CALL EQUATIONS_MATRICES_DYNAMIC_LUMPING_TYPE_SET(EQUATIONS_MATRICES, &
                  & (/EQUATIONS_MATRIX_UNLUMPED,EQUATIONS_MATRIX_UNLUMPED,EQUATIONS_MATRIX_UNLUMPED/),ERR,ERROR,*999)
                ...
                CALL EQUATIONS_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET(EQUATIONS_MATRICES, &
                  & (/EQUATIONS_MATRIX_FEM_STRUCTURE,EQUATIONS_MATRIX_FEM_STRUCTURE,EQUATIONS_MATRIX_FEM_STRUCTURE/),ERR,ERROR,*999)
              ELSE
                SELECT CASE(EQUATIONS%SPARSITY_TYPE)
                  ...
                  CASE(EQUATIONS_MATRICES_SPARSE_MATRICES)
                    LOCAL_ERROR="The equations matrices sparsity type of "// &
                      & TRIM(NUMBER_TO_VSTRING(EQUATIONS%SPARSITY_TYPE,"*",ERR,ERROR))//" is not implemented."
                    CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
                  CASE DEFAULT
                    LOCAL_ERROR="The equations matrices sparsity type of "// &
          ...
          CASE(PROBLEM_SETUP_SOLVERS_TYPE)
            ...
            SELECT CASE(PROBLEM_SETUP%ACTION_TYPE)
              CASE(PROBLEM_SETUP_START_ACTION)
                ...
                !Set the solver to be a second order dynamic solver
                ...
                !Set solver defaults
                CALL SOLVER_DYNAMIC_SCHEME_SET(SOLVER,SOLVER_DYNAMIC_NEWMARK3_SCHEME,ERR,ERROR,*999)
...
999 CALL ERRORS("COUPLED_FINITEELASTIC_DARCY_PRE_SOLVE",ERR,ERROR)
  ...
  SUBROUTINE COUPLED_ELASTICDARCY_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    TYPE(EQUATIONS_MATRIX_TYPE), POINTER :: STIFFNESS_MATRIX,DAMPING_MATRIX,MASS_MATRIX
    TYPE(FIELD_TYPE), POINTER :: DEPENDENT_FIELD,FIBRE_FIELD,GEOMETRIC_FIELD,MATERIALS_FIELD,EQUATIONS_SET_FIELD,SOURCE_FIELD
    TYPE(FIELD_TYPE), POINTER :: INDEPENDENT_FIELD,PREV_VELOCITY_FIELD
    TYPE(FIELD_VARIABLE_TYPE), POINTER :: FIELD_VARIABLE
    ...
    TYPE(FIELD_INTERPOLATION_PARAMETERS_TYPE), POINTER :: GEOMETRIC_INTERPOLATION_PARAMETERS, &
      ...
      & DARCY_MATERIALS_INTERPOLATION_PARAMETERS,SOURCE_INTERPOLATION_PARAMETERS,RHOs_INTERPOLATION_PARAMETERS, &
      & RHOf_INTERPOLATION_PARAMETERS,INDEPENDENT_INTERPOLATION_PARAMETERS
    TYPE(FIELD_INTERPOLATION_PARAMETERS_PTR_TYPE), POINTER :: PREV_VELOCITY_INTERP_PARAMETERS(:)
    TYPE(FIELD_INTERPOLATED_POINT_TYPE), POINTER :: GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT, &
      ...
      & RHOs_INTERPOLATED_POINT,INDEPENDENT_INTERPOLATED_POINT,DARCY_MATERIALS_INTERPOLATED_POINT, &
      & PREV_VELOCITY_INTERPOLATED_POINT,RHOf_INTERPOLATED_POINT,PREV_VELOCITY_INTERP_POINT
    ...
    REAL(DP) :: FIRST_PIOLA_TENSOR(3,3),DZDNU_INV_T(3,3),DZDNUT(3,3)
    ...
    NULLIFY(INDEPENDENT_INTERPOLATION_PARAMETERS,PREV_VELOCITY_INTERP_PARAMETERS)
    NULLIFY(RHOs_INTERPOLATION_PARAMETERS,RHOf_INTERPOLATION_PARAMETERS)
    ...
    NULLIFY(RHOs_INTERPOLATED_POINT,INDEPENDENT_INTERPOLATED_POINT,PREV_VELOCITY_INTERP_POINT)
    NULLIFY(RHOf_INTERPOLATED_POINT,DEPENDENT_BASIS_1)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN 
        ...
        MASS_MATRIX%ELEMENT_MATRIX%MATRIX=0.0_DP
        ...
        ENDDO
        SECOND_PIOLA_TENSOR=DZDNU ! copy the identity matrix
        FIRST_PIOLA_TENSOR=DZDNU !copy identity matrix
        ...
        !Create prev-velocity interpolation parameters
        CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(DEPENDENT_FIELD,PREV_VELOCITY_INTERP_PARAMETERS,ERR,ERROR,*999)
       ...
       !Grab material interpolation parameters for the solid mech properties variable type
        ...
        CALL FIELD_INTERPOLATION_PARAMETERS_ELEMENT_GET(FIELD_PREVIOUS_VELOCITY_SET_TYPE,ELEMENT_NUMBER, &
          & PREV_VELOCITY_INTERP_PARAMETERS(FIELD_U_VARIABLE_TYPE)%PTR,ERR,ERROR,*999)
        ...
        CALL FIELD_INTERPOLATED_POINT_INITIALISE(PREV_VELOCITY_INTERP_PARAMETERS(FIELD_U_VARIABLE_TYPE)%PTR, & 
          & PREV_VELOCITY_INTERP_POINT,ERR,ERROR,*999)
        ...
        CASE(EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE, &
          ...
          DO gauss_idx=1,DEPENDENT_NUMBER_OF_GAUSS_POINTS
            ...
            IF(NUMBER_OF_DIMENSIONS.EQ.1) THEN
              DZDNU_INV(1,1) = 1.0_DP/DZDNU(1,1)
              DET_DZDNU = DZDNU(1,1)
              DZDNU_INV_T(1,1) = DZDNU_INV(1,1)
            ELSE
            ...
            !Calculate SECOND_PIOLA_KIRCHOFF_TENSOR_EFF'
            CALL COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR(EQUATIONS_SET,DEPENDENT_INTERPOLATED_POINT, &
              & MATERIALS_INTERPOLATED_POINT, &
              & INDEPENDENT_INTERPOLATED_POINT,SECOND_PIOLA_TENSOR,Jznu,DZDNU,NUMBER_OF_DIMENSIONS,&
            ...
            DO component_idx=1,NUMBER_OF_DIMENSIONS
              ...
              ELSEIF(DEPENDENT_COMPONENT_INTERPOLATION_TYPE==FIELD_ELEMENT_BASED_INTERPOLATION) THEN
                ...
                CALL FLAG_ERROR( &
                  & "Finite elasticity-Darcy with element based displacement interpolation is not implemented.", &
                  & ERR,ERROR,*999)
              ENDIF
            ENDDO ! component_idx

            !DIV_VELOCITY = deludot/delx + delvdot/dely + delwdot/delz
            ...
            ELSEIF(HYDROSTATIC_COMPONENT_INTERPOLATION_TYPE==FIELD_ELEMENT_BASED_INTERPOLATION) THEN !element based
              !Will probably never be used
              CALL FLAG_ERROR("Finite elasticity-Darcy with element based interpolation for pressure is not implemented." &
                & ,ERR,ERROR,*999)
            ENDIF
        ...
        CASE DEFAULT
          ...
          CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
        END SELECT
        !Get solid,fluid densities, porosity to calculate total density - RHOo
        IF(ASSOCIATED(MATERIALS_FIELD%VARIABLE_TYPE_MAP(FIELD_V_VARIABLE_TYPE)%PTR)) THEN
          RHOs_INTERPOLATION_PARAMETERS=>EQUATIONS%INTERPOLATION%MATERIALS_INTERP_PARAMETERS(FIELD_V_VARIABLE_TYPE)%PTR
          CALL FIELD_INTERPOLATION_PARAMETERS_ELEMENT_GET(FIELD_VALUES_SET_TYPE,ELEMENT_NUMBER, &
            & RHOs_INTERPOLATION_PARAMETERS,ERR,ERROR,*999)
          RHOs_INTERPOLATED_POINT=>EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_V_VARIABLE_TYPE)%PTR
        ENDIF
        ...
        IF(ASSOCIATED(MATERIALS_FIELD%VARIABLE_TYPE_MAP(FIELD_V1_VARIABLE_TYPE)%PTR)) THEN
          RHOf_INTERPOLATION_PARAMETERS=>EQUATIONS%INTERPOLATION%MATERIALS_INTERP_PARAMETERS(FIELD_V1_VARIABLE_TYPE)%PTR
          CALL FIELD_INTERPOLATION_PARAMETERS_ELEMENT_GET(FIELD_VALUES_SET_TYPE,ELEMENT_NUMBER, &
            & RHOf_INTERPOLATION_PARAMETERS,ERR,ERROR,*999)
          RHOf_INTERPOLATED_POINT=>EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_V1_VARIABLE_TYPE)%PTR
        ENDIF
        ...
        IF(MASS_MATRIX%UPDATE_MATRIX.OR.STIFFNESS_MATRIX%UPDATE_MATRIX.OR.DAMPING_MATRIX%UPDATE_MATRIX) THEN
          ...
          DO gauss_idx=1,DEPENDENT_NUMBER_OF_GAUSS_POINTS
            ...
            CALL COUPLED_ELASTICDARCY_GAUSS_DEFORMATION_GRADIENT_TENSOR(DEPENDENT_INTERPOLATED_POINT, &
              ...
              & NUMBER_OF_XI,DZDNU,Jxxi,ERR,ERROR,*999)
            IF(NUMBER_OF_DIMENSIONS.EQ.1) THEN
              DZDNU_INV = 1.0_DP/DZDNU(1,1)
              DET_DZDNU = DZDNU(1,1)
              DZDNUT(1,1) = DZDNU(1,1)
              AZL(1,1) = DZDNUT(1,1)*DZDNU(1,1)
              AZU(1,1) = 1.0_DP/AZL(1,1)
              I3 = 1.0_DP/AZL(1,1)
            ELSE
              CALL INVERT(DZDNU,DZDNU_INV,DET_DZDNU,ERR,ERROR,*999)
              CALL MATRIX_TRANSPOSE(DZDNU_INV,DZDNU_INV_T,ERR,ERROR,*999)
            ...
            DO component_idx=1,NUMBER_OF_DIMENSIONS
              ...
              DO parameter_idx=1,NUMBER_OF_FIELD_COMPONENT_INTERPOLATION_PARAMETERS
                ...
                IF(HYDROSTATIC_COMPONENT_INTERPOLATION_TYPE==FIELD_NODE_BASED_INTERPOLATION) THEN
                  ...
                  DO parameter_idx2=1,DEPENDENT_BASIS_TWO%NUMBER_OF_ELEMENT_PARAMETERS
                    ...
                    IF(STIFFNESS_MATRIX%UPDATE_MATRIX) THEN
                      !SUM=0.0_DP
                      !DO idx_tensor=1,NUMBER_OF_DIMENSIONS
                      !  SUM=SUM+DFUDX(parameter_idx,idx_tensor)*DZDNU_INV_T(idx_tensor,component_idx)
                      !ENDDO
                      STIFFNESS_MATRIX%ELEMENT_MATRIX%MATRIX(imatrix,jmatrix) = &
                        & STIFFNESS_MATRIX%ELEMENT_MATRIX%MATRIX(imatrix,jmatrix)- &
                      !  & RWG*SUM*PHIi
                ...
                ELSEIF(HYDROSTATIC_COMPONENT_INTERPOLATION_TYPE==FIELD_ELEMENT_BASED_INTERPOLATION) THEN
                  jmatrix=jmatrix+1
                  CALL FLAG_ERROR( &
                    & "Finite elasticity-Darcy with element based interpolation for pressure is not implemented.", &
                    & ERR,ERROR,*999)
...
999 CALL ERRORS("COUPLED_FINITEELASTIC_DARCY_POST_SOLVE",ERR,ERROR)
  ...
  SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_DEFORMATION_GRADIENT_TENSOR(DEPENDENT_INTERPOLATED_POINT,GEOMETRIC_INTERPOLATED_POINT,&
    ...
    IF(DIAGNOSTICS1) THEN
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,DXDNU,WRITE_STRING_MATRIX_NAME_AND_INDICES,'("    DXDNU','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)

      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,DZDXI,WRITE_STRING_MATRIX_NAME_AND_INDICES,'("    DNUDXI','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)        
    ENDIF
    ...
    IF(DIAGNOSTICS1) THEN
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,DXDXI,WRITE_STRING_MATRIX_NAME_AND_INDICES,'("    DXDXI','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)

      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,DZDXI,WRITE_STRING_MATRIX_NAME_AND_INDICES,'("    DZDXI','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)
        
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,DZDNU,WRITE_STRING_MATRIX_NAME_AND_INDICES, &
        & '("    DEFORMATION_GRADIENT_TENSOR','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)
    ENDIF
...
999 CALL ERRORS("COUPLED_ELASTICDARCY_GAUSS_DEFORMATION_GRADIENT_TENSOR",ERR,ERROR)
  ...
  SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR(EQUATIONS_SET,DEPENDENT_INTERPOLATED_POINT, &
    ...
    REAL(DP), INTENT(IN) :: DZDNU(:,:) !Deformation gradient tensor at the Guass point
    INTEGER(INTG), INTENT(IN) :: DIMEN  !<The number of dimensions
    ...
    CALL ENTERS("COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR",ERR,ERROR,*999)
    ...
    !SECOND_PIOLA_TENSOR_EFF is the second Piola-Kirchoff tensor (PK2 or S)
    ...
    IF(DIAGNOSTICS1) THEN
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,E,WRITE_STRING_MATRIX_NAME_AND_INDICES,'("    E','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)
    ENDIF
    IDENTITY=0.0_DP
    DO i=1,DIMEN
    ...
    CASE(EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE)
      ...
      ! W=c1/2*(I1-3)-c1*lnJ+c2/2(lnJ)^2 - PC^-1
      !  Note that because PIOLA = 2.del{W}/del{C}=c1[1]+(c2lnJ-c1)C^-1
      SECOND_PIOLA_TENSOR_EFF(1,1)=mu*IDENTITY(1,1)+(lambda*LOG(Jznu)-mu)*AZU(1,1)
      SECOND_PIOLA_TENSOR(1,1) = SECOND_PIOLA_TENSOR_EFF(1,1)-(P*AZU(1,1))
      IF(DIMEN.GT.1) THEN
        SECOND_PIOLA_TENSOR_EFF(1,2)=mu*IDENTITY(1,2)+(lambda*LOG(Jznu)-mu)*AZU(1,2)
        SECOND_PIOLA_TENSOR_EFF(2,1)=SECOND_PIOLA_TENSOR_EFF(1,2)
        SECOND_PIOLA_TENSOR_EFF(2,2)=mu*IDENTITY(2,2)+(lambda*LOG(Jznu)-mu)*AZU(2,2)

        SECOND_PIOLA_TENSOR(1,2) = SECOND_PIOLA_TENSOR_EFF(1,2)-(P*AZU(1,2))
        SECOND_PIOLA_TENSOR(2,2) = SECOND_PIOLA_TENSOR_EFF(2,2)-(P*AZU(2,2))
        SECOND_PIOLA_TENSOR(2,1) = SECOND_PIOLA_TENSOR(1,2)
      ENDIF
      IF(DIMEN.GT.2) THEN
        SECOND_PIOLA_TENSOR_EFF(1,3)=mu*IDENTITY(1,3)+(lambda*LOG(Jznu)-mu)*AZU(1,3)
        SECOND_PIOLA_TENSOR_EFF(2,3)=mu*IDENTITY(2,3)+(lambda*LOG(Jznu)-mu)*AZU(2,3)
        SECOND_PIOLA_TENSOR_EFF(3,1)=SECOND_PIOLA_TENSOR_EFF(1,3)
        SECOND_PIOLA_TENSOR_EFF(3,2)=SECOND_PIOLA_TENSOR_EFF(2,3)
        SECOND_PIOLA_TENSOR_EFF(3,3)=mu*IDENTITY(3,3)+(lambda*LOG(Jznu)-mu)*AZU(3,3)

        SECOND_PIOLA_TENSOR(1,3) = SECOND_PIOLA_TENSOR_EFF(1,3)-(P*AZU(1,3))
        SECOND_PIOLA_TENSOR(2,3) = SECOND_PIOLA_TENSOR_EFF(2,3)-(P*AZU(2,3))
        SECOND_PIOLA_TENSOR(3,1) = SECOND_PIOLA_TENSOR(1,3)
        SECOND_PIOLA_TENSOR(3,2) = SECOND_PIOLA_TENSOR(2,3)
        SECOND_PIOLA_TENSOR(3,3) = SECOND_PIOLA_TENSOR_EFF(3,3)-(P*AZU(3,3))
      ...
      SECOND_PIOLA_TENSOR(1,1)=SECOND_PIOLA_TENSOR(1,1)+ACTIVE_STRESS_11
      IF(DIMEN.GT.1) THEN
        CALL FIELD_PARAMETER_SET_GET_GAUSS_POINT(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD, & 
          &  FIELD_U_VARIABLE_TYPE,&
        ...
        SECOND_PIOLA_TENSOR(2,2)=SECOND_PIOLA_TENSOR(2,2)+ACTIVE_STRESS_22
      ENDIF
      IF(DIMEN.GT.2) THEN
        CALL FIELD_PARAMETER_SET_GET_GAUSS_POINT(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD, & 
          &  FIELD_U_VARIABLE_TYPE,&
        ...
        SECOND_PIOLA_TENSOR(3,3)=SECOND_PIOLA_TENSOR(3,3)+ACTIVE_STRESS_33 
      ENDIF
    CASE(EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE)
      !Form of constitutive model is:
      ! W=c1*(I1-3)+c2*(I2-3) - PC^-1
      ! 
      c1  = C(1)
      c2 = C(2)

      IF(DIMEN.GE.2) THEN
        SECOND_PIOLA_TENSOR(1,1)=2.0_DP*(C(1)+C(2)*(AZL(2,2)+AZL(3,3))+P*AZU(1,1))
        SECOND_PIOLA_TENSOR(1,2)=2.0_DP*(     C(2)*(-AZL(2,1))        +P*AZU(1,2))
        SECOND_PIOLA_TENSOR(2,1)=SECOND_PIOLA_TENSOR(1,2)
        SECOND_PIOLA_TENSOR(2,2)=2.0_DP*(C(1)+C(2)*(AZL(3,3)+AZL(1,1))+P*AZU(2,2))
      ENDIF
      IF(DIMEN.EQ.3) THEN
        SECOND_PIOLA_TENSOR(1,3)=2.0_DP*(       C(2)*(-AZL(3,1))        +P*AZU(1,3))
        SECOND_PIOLA_TENSOR(2,3)=2.0_DP*(       C(2)*(-AZL(3,2))        +P*AZU(2,3))
        SECOND_PIOLA_TENSOR(3,1)=SECOND_PIOLA_TENSOR(1,3)
        SECOND_PIOLA_TENSOR(3,2)=SECOND_PIOLA_TENSOR(2,3)
        SECOND_PIOLA_TENSOR(3,3)=2.0_DP*(C(1)+C(2)*(AZL(1,1)+AZL(2,2))+P*AZU(3,3))       
      ENDIF
      !add active contraction stress value to the trace of the stress tensor - basically adding to hydrostatic pressure.
      !the active stress is stored inside the independent field that has been set up in the user program.
      !for generality we could set up 3 components in independent field for 3 different active stress components
    ...
    IF(DIAGNOSTICS1) THEN
      ...
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,DIMEN,1,1,DIMEN, &
        & DIMEN,DIMEN,SECOND_PIOLA_TENSOR_EFF,WRITE_STRING_MATRIX_NAME_AND_INDICES, &
        & '("    SECOND_PIOLA_TENSOR_EFF','(",I1,",:)',' :",3(X,E13.6))', &
        & '(17X,3(X,E13.6))',ERR,ERROR,*999)
    ENDIF
    NULLIFY(C)

    CALL EXITS("FINITE_ELASTICITY_GAUSS_SECOND_PIOLA_TENSOR")
    RETURN
999 CALL ERRORS("COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR",ERR,ERROR)
    CALL EXITS("COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR")
    RETURN 1
  END SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR
  !
  !================================================================================================================================
  !
...
999 CALL ERRORS("COUPLED_ELASTICDARCY_GAUSS_DFDZ",ERR,ERROR)
  ...
  !>Evaluates df/dz (derivative of interpolation function wrt deformed coord) matrix at a given Gauss point
  SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY(DEPENDENT_INTERPOLATED_POINT,PREV_VELOCITY_INTERPOLATED_POINT, &
    & NUMBER_OF_DIMENSIONS,NUMBER_OF_XI,DIV_VELOCITY,ERR,ERROR,*)

    !Argument variables
    TYPE(FIELD_INTERPOLATED_POINT_TYPE), POINTER :: DEPENDENT_INTERPOLATED_POINT,PREV_VELOCITY_INTERPOLATED_POINT !<Interpolated point for the dependent field
    INTEGER(INTG), INTENT(IN) :: NUMBER_OF_DIMENSIONS !<The number of dimensions
    INTEGER(INTG), INTENT(IN) :: NUMBER_OF_XI !<The number of xi directions for the interpolation
    REAL(DP), INTENT(OUT) :: DIV_VELOCITY !<On return, the divergence of velocity
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    TYPE(BASIS_TYPE), POINTER :: COMPONENT_BASIS
    ...
    INTEGER(INTG) :: NUMBER_OF_FIELD_COMPONENT_INTERPOLATION_PARAMETERS,derivative_idx,component_idx,xi_idx,parameter_idx 
    REAL(DP) :: DXIDZ(NUMBER_OF_DIMENSIONS,NUMBER_OF_DIMENSIONS),DZDXI(NUMBER_OF_DIMENSIONS,NUMBER_OF_DIMENSIONS)
    REAL(DP) :: Jzxi,DudotDXI(NUMBER_OF_DIMENSIONS,NUMBER_OF_DIMENSIONS)!temporary until a proper alternative is found
    
    CALL ENTERS("COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY",ERR,ERROR,*999)

    !Initialise DFDXI array
    DudotDXI=0.0_DP  ! DudotDXI(component_idx,parameter_idx,xi_idx)
    DZDXI = 0.0_DP
    DO component_idx=1,NUMBER_OF_DIMENSIONS !Always 3 spatial coordinates (3D)
      DO xi_idx=1,NUMBER_OF_XI !Thus always 3 element coordinates
        derivative_idx=PARTIAL_DERIVATIVE_FIRST_DERIVATIVE_MAP(xi_idx)  !2,4,7      
    ...
    DO component_idx=1,NUMBER_OF_DIMENSIONS
      DO xi_idx=1,NUMBER_OF_XI
        DIV_VELOCITY = DIV_VELOCITY+DudotDXI(component_idx,xi_idx)*DXIDZ(xi_idx,component_idx) 
      ENDDO
    ENDDO


    CALL EXITS("COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY")
    RETURN
999 CALL ERRORS("COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY",ERR,ERROR)
    CALL EXITS("COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY")
    RETURN 1
  END SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_DIV_VELOCITY
