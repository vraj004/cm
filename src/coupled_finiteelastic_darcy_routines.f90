...
999 CALL ERRORS("COUPLED_ELASTICDARCY_GAUSS_DEFORMATION_GRADIENT_TENSOR",ERR,ERROR)
  ...
  SUBROUTINE COUPLED_ELASTICDARCY_GAUSS_SECOND_PIOLA_TENSOR(EQUATIONS_SET,DEPENDENT_INTERPOLATED_POINT, &
    ...
    REAL(DP) :: AZL(3,3),AZU(3,3),DZDNUT(3,3),SECOND_PIOLA_TENSOR_EFF(3,3),E(3,3),P,IDENTITY(3,3),AZLT(3,3),AZUT(3,3)
    ...
    IF(DIAGNOSTICS1) THEN
      ...
      CALL WRITE_STRING_MATRIX(DIAGNOSTIC_OUTPUT_TYPE,1,1,3,1,1,3, &
        & 3,3,SECOND_PIOLA_TENSOR_EFF,WRITE_STRING_MATRIX_NAME_AND_INDICES, &
