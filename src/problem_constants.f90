...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_REACTION_DIFFUSION_FINITE_ELASTIC_TYPE=9
  !Problem subtypes
...
!  INTEGER(INTG), PARAMETER :: PROBLEM_HJ_SUBTYPE=6
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_TRANSIENT_SUPG_NAVIER_STOKES_SUBTYPE=9
...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANGSPLIT_REACDIFF_FINITE_ELASTIC_SUBTYPE=143
