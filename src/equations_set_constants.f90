...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COUPLED_FINITEELASTIC_DARCY_TYPE=6
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSE_ISOTROPIC_HUMPHREY_YIN_SUBTYPE=20
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_ACTIVECONTRACTION_SUBTYPE=21
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STVENANT_KIRCHOFF_ACTIVECONTRACTION_SUBTYPE=22
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_ACTIVECONTRACTION_SUBTYPE=23
...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICDARCY_ACTIVECONTRACTION_SUBTYPE=143
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICDARCY_MNRV_CONTRACTION_SUBTYPE=144
